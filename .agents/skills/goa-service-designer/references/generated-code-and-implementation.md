...
- For gRPC, follow the selected release's protobuf compiler and plugin requirements. The preview
  checks `protoc-gen-go` and `protoc-gen-go-grpc` versions; do not fix a mismatch by changing
