...
- **Go 1.25 o posterior** - Goa aprovecha las características modernas de Go
...
Añade `fmt` a los imports de `hello.go`.
...
Esta versión de Clue mantiene el código inicial generado compatible con Go 1.25.
