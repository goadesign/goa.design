...
The scaffold code generated by the `main` command is generated once as a way to get started
quickly. This code is meant to be edited, tested and in general handled like any other file
written "manually". `goagen` does not override the scaffold files if they already exist. The
`main` package of the client tool generated by the `client` command is also scaffold.
