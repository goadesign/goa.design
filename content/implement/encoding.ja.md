...
The generated server contructors accept an encoder and a decoder constructor functions as argument
...
`msgpack`. As indicated in the overview a decoder must implement the `Decoder` interface and can
