...
roughly four months ago. This includes 34 bug fixes, 10 new features and 59
other minor improvements made by 24 contributors. This being a `v1.x.x`
release means that all existing users currently using `v1.0.0` can upgrade
seamlessly with no modification to the existing code.
...
### Security Improvements
 ...
 [Jared Bischof](https://github.com/jaredbischof) added the ability to
dynamically change the set of JWT keys used to authorize incoming requests.
...
* [Added the ability to dynamically add/remove keys from the jwt security middleware after creation.](https://github.com/goadesign/goa/pull/818)
* [Refactor JWT key resolver](https://github.com/goadesign/goa/pull/832)
