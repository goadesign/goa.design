...
Both the design language and code generators are extensible via [plugins](/v1/extend/), for example
the [gorma plugin](/v1/extend/gorma/) allows defining database models in the design and generates
...
necessary. The [design](/v1/design/) section introduces the language.

### Artifact Generation

goa comes with the [goagen](/v1/implement/goagen/) tool which produces various outputs from the
...
The [goa package and its sub-packages](/v1/reference/) provide the service implementation scaffolding
...
[implement](/v1/implement/) section describes these components.
