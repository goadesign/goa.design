...
linkTitle: "なぜGoa？"
weight: 2
description: "コードの30-50%を自動生成し、開発速度を大幅に向上させながら、型安全性とクリーンなアーキテクチャを維持するGoaの特長を紹介します。"
---
...
**開発の加速**  
コードベースの30-50%が自動生成 - 記述、テスト、保守が必要なコードが大幅に削減。

**ボイラープレートなし**  
トランスポート、バリデーション、ドキュメント、クライアント生成をGoaが処理する間、ビジネスロジックに集中可能。

**迅速な反復**  
API設計を変更し、すべてのサポートコードを即座に再生成。

**保守の軽減**  
生成されたコードにより、バグが少なく、管理すべき技術的負債も削減。
{{< /alert >}}
